<?php
//to view, go to shopsimply.me/daily_chart.php
...
$sql = "SELECT concat(month(date_time),'-',day(date_time)) as month_day, /*count(id) as num_trxn,*/ sum(amount) as amount_spent
from trxn where left(current_date,7) = left(date_time,7) group by 1 order by date_time";
...
$myPicture->drawText(250,55,"Spending by Day",array("FontSize"=>12,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
$myPicture->drawScale();
$myPicture->drawBarChart(array("DisplayValues"=>TRUE,"DisplayColor"=>DISPLAY_AUTO,"Rounded"=>TRUE,"Surrounding"=>60));
//$myPicture->drawSplineChart();
$myPicture->autoOutput("daily.png");
?>